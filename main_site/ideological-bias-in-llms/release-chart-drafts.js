const PAPER_URL = new URL('./data/paper-data.v2.json?v=20260813c', import.meta.url);
const RESULTS_URL = new URL('./data/website-experiment-results.v1.json?v=20260813c', import.meta.url);
